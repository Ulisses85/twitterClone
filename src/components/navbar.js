    ...
    return (
      <div className="container-fluid is-clearfix container-custom">
        <nav className="nav nav-custom has-shadow">
          ...
          <a className="nav-item custom-nav-item"><i className="fa fa-home icon-twt"></i>Home</a>
          <a className="nav-item custom-nav-item"><i className="fa fa-bolt icon-twt"></i>Moments</a>
          <a className="nav-item custom-nav-item"><i className="fa fa-bell icon-twt"></i>Notifications</a>
          <a className="nav-item custom-nav-item"><i className="fa fa-envelope icon-twt"></i>Messages</a>
          </div>
